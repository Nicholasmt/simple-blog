...
function unblock_timetable(ev)
{
    ...
    $.ajax({
        ...
        url: base_url + "/admin/timetable/unblock",
        method: "POST",
        data: {tsid:tsid},
        beforeSend: function () {
            if (confirm("Confirm that you want to unblock the timetable ?"))
            return true;
            else return false;
        },
        success: function (data, status, error) {
...
$("body").on("click", "#unblock_timetable", unblock_timetable);
